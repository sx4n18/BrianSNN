...
for name in population_names:
    ...
    neuron_groups[name+'e'] = neuron_groups['e'] #.subgroup(n_e)  this function has been removed from brian2 library
    ...
    for conn_type in recurrent_conn_names:
        ...
        connections[connName] = b.Synapses(neuron_groups[connName[0:2]], neuron_groups[connName[2:4]], structure= conn_structure,
                                                    state = 'g'+conn_type[0])
...
for name in input_connection_names:
    ...
    for connType in input_conn_names:
        ...
        connections[connName] = b.Synapses(input_groups[connName[0:2]], neuron_groups[connName[2:4]], structure= conn_structure,
